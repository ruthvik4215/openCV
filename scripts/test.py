...
img_asset = cv2.imread('assets/chessboard.png')
img_asset = cv2.resize(img, (0, 0), fx=0.75, fy=0.75)
gray_scaled_image = cv2.cvtColor(img_asset, cv2.COLOR_BGR2GRAY)
...
for corner in corners_cut:
	x, y = corner.ravel()
	cv2.circle(img_asset, (x, y), 5, (255, 0, 0), -1)
